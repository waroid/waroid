...
namespace HARPYBOT
{
	...
	{ DRON_IDEL_VALUE, DRON_IDEL_VALUE + OFFSET, DRON_IDEL_VALUE },	//forward
	{ DRON_IDEL_VALUE + OFFSET, DRON_IDEL_VALUE + OFFSET, DRON_IDEL_VALUE },	//right forward
	{ DRON_IDEL_VALUE + OFFSET, DRON_IDEL_VALUE, DRON_IDEL_VALUE },	//right
	{ DRON_IDEL_VALUE + OFFSET, DRON_IDEL_VALUE - OFFSET, DRON_IDEL_VALUE },	//right backward
	{ DRON_IDEL_VALUE, DRON_IDEL_VALUE - OFFSET, DRON_IDEL_VALUE },	//backward
	{ DRON_IDEL_VALUE - OFFSET, DRON_IDEL_VALUE - OFFSET, DRON_IDEL_VALUE },	//left backward
	{ DRON_IDEL_VALUE - OFFSET, DRON_IDEL_VALUE, DRON_IDEL_VALUE },	//left
	{ DRON_IDEL_VALUE - OFFSET, DRON_IDEL_VALUE + OFFSET, DRON_IDEL_VALUE },	//left forward
