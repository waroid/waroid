...
using namespace WARBOT2;

Warbot2::Warbot2(char team)
		: Robot(EROBOT::WARBOT2, team)
{
...
void Warbot2::onReset()
{
	m_pololuQik.init();
	Robot::onReset();
}

void Warbot2::onMove(int data0, int data1)
{
	int dir = data0;
